...
<form action="" method="post">
	<p>
		...
		<div class="alert alert-danger" id="no-id-alert-danger" style="color: red">id를 입력하세요.</div>
		<div class="alert alert-success" id="id-alert-success" style="color: blue" >id 사용가능.</div>
		<div class="alert alert-danger" id="id-alert-danger" style="color: red">id 사용 불가.</div>
	</P>
	<p>
	...
	<p>
		...
		<input type="password" id="pwd1" name="password" required="required" placeholder="7~14자 이내"/>
	</P>
	<p>
		<div>
			<label for="password2">비밀번호 확인</label>
			<input type="password" id="pwd2" name="password2" required="required"/>
		</div>	
